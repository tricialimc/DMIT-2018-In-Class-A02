...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <!--ObjectDataSource control to do the underlying communication with my BLL and my ListView control -->
        <asp:ObjectDataSource ID="SpecialEventsDataSource" runat="server" TypeName="eRestaurant.Framework.BLL.RestaurantAdminController"
            SelectMethod="ListAllSpecialEvents" DataObjectTypeName="eRestaurant.Framework.Entities.SpecialEvent" OldValuesParameterFormatString="original_{0}" UpdateMethod="UpdateSpecialEvent"
            DeleteMethod="DeleteSpecialEvent" InsertMethod="InsertSpecialEvent" OnDeleted="ProcessExceptions" OnInserted="ProcessExceptions" OnUpdated="ProcessExceptions">
    ...
    <asp:ListView ID ="SpecialEventsListView" runat="server" DataSourceID="SpecialEventsDataSource" 
        ...
        <EditItemTemplate>
            <div>
                ...
                Description:
                <asp:TextBox runat="server" ID="DescriptionTextBox" Text='<%# Bind("Description") %>' Enabled="true" />
        ...
        <InsertItemTemplate>
            <div>
                ...
                <asp:Label ID="Label3" runat="server" CssClass="control-label" AssociatedControlID="EventCodeTextBox">
                    EventCode
                </asp:Label>
                <asp:TextBox ID="EventCodeTextBox" runat="server" Text='<%# Bind("EventCode") %>'></asp:TextBox>
                &mdash;

                <asp:Label ID="Label4" runat="server" CssClass="control-label" AssociatedControlID="DescriptionTextBox">
                    Description
                </asp:Label>
