...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="row col-md-12">
                ...
                <div>   
                    ...
                    <div class="well">
                        <asp:Repeater ID="ItemDetailRepeater" runat="server"
                            DataSource="<%#Item.MenuItems%>" ItemType="eRestaurant.Framework.Entities.DTOs.MenuItemDTO">
                            <ItemTemplate>
                                <div>
                                    <h4>
                                        <%# Item.Description %>                                    
        ...
        <asp:ObjectDataSource ID="MenuItemDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ListMenuItems" TypeName="eRestaurant.Framework.BLL.MenuController"></asp:ObjectDataSource>
    </div>
</asp:Content>
