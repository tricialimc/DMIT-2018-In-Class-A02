...
namespace eRestaurant.Framework.BLL.Security
{
    ...
    {
        #region Constants
        //Ideally put some or all of these in the Web.config file underneath the <appSettings> element.
        ...
        public void AddDefaultUsers()
        {
            using (var context = new RestaurantContext())
            {
                ...
                foreach(var person in employees)
                {
                    ...
                    //u represents a given user where the user's waiterID has a value
                    ...
                    if(!Users.Any(u=> u.WaiterID.HasValue && u.WaiterID.Value == person.WaiterID))
                    {
                        ...
                        // NOTE: The following line of code needs the use of the "this" keyword
